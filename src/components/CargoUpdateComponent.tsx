...
import { setOpen, updateCargo } from '../redux/slices/cargoSlice'
...
type CargoUpdateProps = {
    cargo: Cargo
}

const CargoUpdateComponent = ({ cargo }: CargoUpdateProps) => {
    ...
    return (
        <div className="w-full bg-amber-50 p-2 mt-6">
...
export default CargoUpdateComponent