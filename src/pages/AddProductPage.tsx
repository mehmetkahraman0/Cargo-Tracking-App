...
const AddProductPage = () => {
    const { warningAlert, successAlert, contextHolder } = useAlert()
    ...
    const handleSave = async () => {
        ...
        await dispatch(addProduct({ productName, serialNo, file: base64Convert })).unwrap()
        successAlert("ürün kayıtı başarılı ürün listesi sayfasına yönlendiriyorsunuz")
        setTimeout(() => {
